...
<div class="art-post-inner art-article">
 ...
 <form method="post" name="form1" id="form1" enctype="multipart/form-data" action="formulario_empleado2.php" onsubmit="return validar()">
<br>   
 
<p align="center" class="Estilo3 Estilo1"><strong>Registro Trabajador </strong></p>
...
<legend><strong>Trabajador</strong></legend>
    ...
    <table border="0" align="center">
        <td width="130"><div align="center"><strong>Cedula </strong></div></td>
        <td width="225"><label>
          <div align="center">
        ...
        <td width="74"><div align="center">
          <input name="nombre_apellido" type="text" id="nombre_apellido" />
        </div></td>
	  ...
	  <tr>
        <?php // formato de la fecha ano, mes y dia
              $hoy=date("Y-m-d");
            ?>
        <td width="70"><div align="center"><strong>Fecha de inicio </strong></div></td>
        <td width="155"><div align="center">
          
		  <input type="text" id="fecha1" name="fecha_inicio" size="10" onKeyPress="return nonumeyletra(event)"readonly="readonly"/>
        ...
        <td width="130"><div align="center"><strong>horario</strong></div></td>
        <td width="225"><div align="center">
