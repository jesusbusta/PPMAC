...
// consulta a la tabla informe_personal	
	$consulta="SELECT * FROM trabajador where match (cedula,nombre_apellido) against ('$criterio*' IN BOOLEAN MODE)";
...
<center>
<CAPTION><strong>CONSULTA De trabajadores</strong></CAPTION>
<p>&nbsp;</p>
...
<?PHP
		...
		while ($row = mysql_fetch_row($resultado))
    {
       //$link2 =$row[9];
		...
		echo "<tr ><td> Sexo: $row[2]</td></tr>";
		echo "<tr><td>Telefono: $row[3]</td><tr >";
       	echo "<tr><td>Fecha de Ingreso: $row[4]</td>";
       	echo "<tr><td>Departamento: $row[5]</td><tr>";
		echo "<tr><td> Horario: $row[6]</td></tr>";
