...
$fechademantenimiento=$_POST['fechademantenimiento'];
...
// funcion para insertar los ddatos en la tabla informe_personal
             $Insertar= "INSERT INTO piezas VALUES('$codigo','$nombre','$tamano','$revision','$fechademantenimiento','$cantidad','$ruta','$titulo')";
